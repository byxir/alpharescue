          ...
          <div className="mb-24 grid grid-cols-1 grid-rows-2 justify-evenly justify-items-center gap-4 lg:grid-cols-2 xl:grid-cols-[auto_auto_auto] xl:grid-rows-[auto_256px_auto]">
            ...
            >
              <ServiceBox
                ...
                description="Наша услуга с оформлением и прогревом аккаунтов подойдет как людям, кто только что создал свою ферму, так и людям, которые давно имеют большое количество аккаунтов. Мы создаем, или берем ваши, аккаунты твиттера, и делаем из них максимально живые страницы на крипто-тематику."
            ...
            >
              <ServiceBox
                ...
                description="Написание софтов и ботов это одна из наших любимых вещей. Мы всегда уделяем особое внимание таким заказам, и выполняем их с душой. У нас собралась команда опытных программистов, которые написали не одну сотню ботов для тем различной сложности."
            ...
            >
              <ServiceBox
                ...
                description="Наша услуга по абузу событий для владельцев ферм заключается в том, что мы берем ваши аккаунты и загоняем их в выбранное вами событие. Так же мы можем абузить любой твиттер гив, если клиенту это понадобиться, прайс так же символический. Все анонсы и объявления о том, что появился новый софт под событие, мы выкладываем в специальный канал для клиентов в дискорде."
    ...
    <div className="">
      ...
      <div className="grid grid-cols-1 items-center justify-items-center gap-8 smx:grid-cols-[3fr_2fr]">
        ...
        <div className="grid w-40 justify-items-center smx:w-32">
          {children}
          <Link href={"https://t.me/rescue_manager"}>
