        ...
        <div className="md:px-6">
          ...
          <div className="md:px-8">
            <p className="">
              ...
              своевременной реакцией на сигналы, наша команда разработала бота,
            ...
            <p>
              ...
              туда и выполните инструкции в сообщении. После успешной
              авторизации в телеграм боте, выберите нужные категории и каналы,
              именно от этих каналов вы и будете получать уведомления, если
              канал вам больше не интересен, вы можете убрать его через
        ...
        <div className="md:px-6">
          ...
          <div className="md:px-8">
            <p>
              ...
              заработать вам при своевременном реагировании на алерт. У нас есть
              ряд каналов, которые посвящены щиткоинам, некоторые каналы
              позволяют заработать более 2000% с аллерта.  Так же есть
              ...
              объявлениях на ОТС площадках. Как видите в нашем дискорде есть
