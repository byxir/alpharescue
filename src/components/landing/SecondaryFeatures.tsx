...
const features = [
  ...
  },
  {
    ...
    description:
      "Наша основная деятельность NFT. Кроме контента по NFT, вы можете найти у нас информацию по трейдингу, ретро дропам, обучающие статьи и АМА, софт для работы с щиткоинами.",
    icon: "../../../book.svg",
  },
  {
    ...
    >
      <Container className={[]}>
        <div className="mx-auto sm:text-center">
          <h2 className="font-benzin text-3xl font-medium  text-almostwhite">
            Расслабтесь, мы обо всем позаботимся
          </h2>
        </div>
        <ul
          role="list"
        ...
        >
          {features.map((feature) => (
            ...
            >
              ...
              <p className="mt-2 text-subtext">{feature.description}</p>
            </li>
          ))}
        </ul>
      </Container>
