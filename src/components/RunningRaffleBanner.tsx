...
export default function Banner() {
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-almostwhite px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      <div
        className="absolute left-[max(-7rem,calc(50%-52rem))] top-1/2 -z-10 -translate-y-1/2 transform-gpu blur-2xl"
        aria-hidden="true"
      >
        <div
          className="aspect-[577/310] w-[36.0625rem] bg-accent"
          style={{
            clipPath:
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <div className="flex items-center space-x-6 text-sm leading-6 text-gray-900">
          <strong className="font-benzin">Lil Skulls - Public Raffle</strong>
          <div className="h-5 w-64 flex-none rounded-full bg-bg p-1 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">
            <div
              className="h-full rounded-full bg-rose-100"
              style={{ width: "54%" }}
            ></div>
          </div>
          <div className="font-montserratBold">
            54 / 100 аккаунтов готовы ...
          </div>
        </div>
      </div>
